...
mlir_fused_add_mean_mul_sub_sum_tanh_34 = async_compile.mlir_auto_fallback('mlir_fused_add_mean_mul_sub_sum_tanh_34', '''
module {
...
''', kernel_meta={'device_str': 'npu', 'device_index': 0, 'num_outputs': 1, 'non_contiguous_indices': {'inputs': [], 'outputs': []}, 'dynamic': False, 'mutated_indices': [], 'traced_graph_cache': 'traced_graph_cache', 'traced_graph_hash': 'cwte5s4wpjncn2gndb2e75ejuzuexlijy3yooeqgwbt5ijsdd5pj', 'num_call_functions': 2, 'signature': {0: '*f32', 1: '*f32', 2: '*f32'}, 'ranks': [3, 1, 3], 'kernel_hash': '49f27687d078be4a62151086bac3679045fdae5a371be32ba758acb2177a7090'})
...
def call(args):
    ...
    mlir_fused_add_mean_mul_sub_sum_tanh_34.run(arg0_1, arg1_1, buf2, stream=stream0)
    del arg0_1
    del arg1_1
    return (buf2, )
