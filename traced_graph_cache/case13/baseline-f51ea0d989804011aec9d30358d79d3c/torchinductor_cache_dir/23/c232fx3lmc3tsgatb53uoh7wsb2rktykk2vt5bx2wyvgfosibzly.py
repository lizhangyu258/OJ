...
mlir_fused__to_copy_add_mean_mul_pow_rsqrt_sub_27 = async_compile.mlir_auto_fallback('mlir_fused__to_copy_add_mean_mul_pow_rsqrt_sub_27', '''
module {
...
''', kernel_meta={'device_str': 'npu', 'device_index': 0, 'num_outputs': 1, 'non_contiguous_indices': {'inputs': [], 'outputs': []}, 'dynamic': True, 'mutated_indices': [], 'traced_graph_cache': 'traced_graph_cache', 'traced_graph_hash': 'ch4j4yhhmylxwracsjqbfv5u6ugy64wwxtzwkichhvxvgn4meecx', 'num_call_functions': 2, 'signature': {0: '*f16', 1: '*f16', 2: '*!torch.int', 3: '*!torch.int', 4: '*!torch.int', 5: '*f16', 6: '*f16', 7: '*f32'}, 'ranks': [3, 3, 1, 1, 1, 1, 1, 3], 'kernel_hash': 'eddae612cf0cba169f4206d29ea7f5a0fc3678432660219712da452fb6bb65be'})
...
def call(args):
    ...
    mlir_fused__to_copy_add_mean_mul_pow_rsqrt_sub_27.run(arg3_1, arg4_1, s2, s0, s1, arg5_1, arg6_1, buf2, stream=stream0)
    del arg3_1
    del arg4_1
    del arg5_1
    del arg6_1
