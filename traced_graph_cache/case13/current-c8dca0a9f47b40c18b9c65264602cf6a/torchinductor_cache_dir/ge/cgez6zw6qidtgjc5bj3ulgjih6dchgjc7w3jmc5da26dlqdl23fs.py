...
mlir_fused__to_copy_add_mean_mul_pow_rsqrt_sub_26 = async_compile.mlir_auto_fallback('mlir_fused__to_copy_add_mean_mul_pow_rsqrt_sub_26', '''
module {
  func.func @mlir_fused__to_copy_add_mean_mul_pow_rsqrt_sub_26(%arg0: tensor<?x?x?xf16>, %arg1: tensor<?x?x?xf16>, %arg2: i64, %arg3: i64, %arg4: i64, %arg5: tensor<?xf16>, %arg6: tensor<?xf16>) -> tensor<?x?x?xf32> attributes {hacc.entry, hacc.function_kind = #hacc.function_kind<HOST>} {
...
''', kernel_meta={'device_str': 'npu', 'device_index': 0, 'num_outputs': 1, 'non_contiguous_indices': {'inputs': [], 'outputs': []}, 'dynamic': True, 'mutated_indices': [], 'traced_graph_cache': 'traced_graph_cache', 'traced_graph_hash': 'c7ox6xdfndkah2nkrmbzfcafehszl3lrc2ks7zlr6yqpkn2qoezc', 'num_call_functions': 2, 'signature': {0: '*f16', 1: '*f16', 2: '*!torch.int', 3: '*!torch.int', 4: '*!torch.int', 5: '*f16', 6: '*f16', 7: '*f32'}, 'ranks': [3, 3, 1, 1, 1, 1, 1, 3], 'kernel_hash': '388e7eff81d48c9573b222e2eaebd9d3143749e63d7b95fad0175e982f149151'})
...
def call(args):
    ...
    s1 = arg1_1
    s2 = arg2_1
    buf2 = empty_strided((s0, s1, s2), (s1*s2, s2, 1), device='npu', dtype=torch.float32)
    stream0 = get_raw_stream(0)
    mlir_fused__to_copy_add_mean_mul_pow_rsqrt_sub_26.run(arg3_1, arg4_1, s2, s0, s1, arg5_1, arg6_1, buf2, stream=stream0)
    del arg3_1
    del arg4_1
    del arg5_1
    del arg6_1
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg1_1 = 160
    arg2_1 = 512
    arg3_1 = rand_strided((32, 160, 512), (81920, 512, 1), device='npu:0', dtype=torch.float16)
    arg4_1 = rand_strided((32, 160, 512), (81920, 512, 1), device='npu:0', dtype=torch.float16)
    arg5_1 = rand_strided((512, ), (1, ), device='npu:0', dtype=torch.float16)
    arg6_1 = rand_strided((512, ), (1, ), device='npu:0', dtype=torch.float16)
