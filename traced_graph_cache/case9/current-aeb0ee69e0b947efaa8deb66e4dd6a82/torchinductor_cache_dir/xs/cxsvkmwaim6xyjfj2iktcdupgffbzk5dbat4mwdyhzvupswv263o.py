...
mlir_fused__to_copy_add_mean_mul_relu_sigmoid_sub_tanh_60 = async_compile.mlir_auto_fallback('mlir_fused__to_copy_add_mean_mul_relu_sigmoid_sub_tanh_60', '''
module {
  func.func @mlir_fused__to_copy_add_mean_mul_relu_sigmoid_sub_tanh_60(%arg0: tensor<256x2048xf16>, %arg1: tensor<1x2048xf16>, %arg2: tensor<256x2048xf16>) -> tensor<256x2048xf32> attributes {hacc.entry, hacc.function_kind = #hacc.function_kind<DEVICE>} {
...
''', kernel_meta={'device_str': 'npu', 'device_index': 0, 'num_outputs': 1, 'non_contiguous_indices': {'inputs': [], 'outputs': []}, 'dynamic': False, 'mutated_indices': [], 'traced_graph_cache': 'traced_graph_cache', 'traced_graph_hash': 'c66xrh64berobvl5ebrigvxwyedx7wsdtl6ozndbdyb66lodgchl', 'num_call_functions': 2, 'signature': {0: '*f16', 1: '*f16', 2: '*f16', 3: '*f32'}, 'ranks': [2, 2, 2, 2], 'kernel_hash': '88c7de9e2c90c41d459942aac126f678395d18cdf6bfd1dbf768b8d2ca87a18c'})
...
def call(args):
    ...
    mlir_fused__to_copy_add_mean_mul_relu_sigmoid_sub_tanh_60.run(arg0_1, arg2_1, arg1_1, buf1, stream=stream0)
    del arg0_1
    del arg1_1
    del arg2_1
    return (buf1, )
