...
"""
mlir_fused__to_copy_20 = async_compile.import_fx('mlir_fused__to_copy_20', kernel_meta={'device_str': 'npu', 'device_index': 0, 'num_outputs': 1, 'non_contiguous_indices': {'inputs': [], 'outputs': []}, 'dynamic': True, 'mutated_indices': [], 'traced_graph_cache': 'traced_graph_cache', 'traced_graph_hash': 'cvtrwifi6tqnmamp7ap2ddpcnwil3mnnrpuszfjcbzinlyo4j3pt', 'num_call_functions': 1})
...
"""
mlir_fused__to_copy_21 = async_compile.import_fx('mlir_fused__to_copy_21', kernel_meta={'device_str': 'npu', 'device_index': 0, 'num_outputs': 1, 'non_contiguous_indices': {'inputs': [], 'outputs': []}, 'dynamic': True, 'mutated_indices': [], 'traced_graph_cache': 'traced_graph_cache', 'traced_graph_hash': 'cyhkfh473fzl72nsyyqve2xxiscpapaqdj4zg5ix35upk4oztpss', 'num_call_functions': 1})


mlir_fused__to_copy_add_mean_mul_relu_22 = async_compile.mlir_auto_fallback('mlir_fused__to_copy_add_mean_mul_relu_22', '''
module {
  func.func @mlir_fused__to_copy_add_mean_mul_relu_22(%arg0: tensor<?x?xf32>, %arg1: tensor<?x1xf16>, %arg2: i64, %arg3: i64) -> tensor<?x?xf32> attributes {hacc.entry, hacc.function_kind = #hacc.function_kind<HOST>} {
...
''', kernel_meta={'device_str': 'npu', 'device_index': 0, 'num_outputs': 1, 'non_contiguous_indices': {'inputs': [], 'outputs': []}, 'dynamic': True, 'mutated_indices': [], 'traced_graph_cache': 'traced_graph_cache', 'traced_graph_hash': 'cgfeg5riysdz5hb62gpi3nbynvgoppr3ifn23o3r5gy5ge6wr6zh', 'num_call_functions': 2, 'signature': {0: '*f32', 1: '*f16', 2: '*!torch.int', 3: '*!torch.int', 4: '*f32'}, 'ranks': [2, 2, 1, 1, 2], 'kernel_hash': 'a586a7c42cf3e1efd5c492f7947956afb9b27c73fadc9e9205f97ca12dc00f32'})
...
def call(args):
    ...
    mlir_fused__to_copy_20.run(arg5_1, buf0, stream=stream0)
    del arg5_1
    buf1 = empty_strided((s0, s1), (s1, 1), device='npu', dtype=torch.float32)
    mlir_fused__to_copy_21.run(arg2_1, buf1, stream=stream0)
    del arg2_1
    buf2 = empty_strided((s1, s3), (s3, 1), device='npu', dtype=torch.float32)
    mlir_fused__to_copy_21.run(arg4_1, buf2, stream=stream0)
    del arg4_1
    ...
    mlir_fused__to_copy_add_mean_mul_relu_22.run(buf4, arg6_1, s0, s3, buf6, stream=stream0)
    del arg6_1
    return (buf6, )
