...
mlir_fused__to_copy_add_mean_mul_relu_sub_19 = async_compile.mlir_auto_fallback('mlir_fused__to_copy_add_mean_mul_relu_sub_19', '''
module {
  func.func @mlir_fused__to_copy_add_mean_mul_relu_sub_19(%arg0: tensor<?x?xf16>, %arg1: tensor<1x?xf16>, %arg2: i64, %arg3: i64, %arg4: tensor<?x1xf16>) -> tensor<?x?xf32> attributes {hacc.entry, hacc.function_kind = #hacc.function_kind<HOST>} {
...
''', kernel_meta={'device_str': 'npu', 'device_index': 0, 'num_outputs': 1, 'non_contiguous_indices': {'inputs': [], 'outputs': []}, 'dynamic': True, 'mutated_indices': [], 'traced_graph_cache': 'traced_graph_cache', 'traced_graph_hash': 'cryzrhaaly7esjw53gfj3e3ij4modte3gcnfsvhdi4f6thcok5cb', 'num_call_functions': 2, 'signature': {0: '*f16', 1: '*f16', 2: '*!torch.int', 3: '*!torch.int', 4: '*f16', 5: '*f32'}, 'ranks': [2, 2, 1, 1, 2, 2], 'kernel_hash': '41d4b36417c66490dbd080978e42eaef1b3266ea970bc081fd9a6698ede83670'})
...
def call(args):
    ...
    mlir_fused__to_copy_add_mean_mul_relu_sub_19.run(arg2_1, arg3_1, s0, s1, arg4_1, buf1, stream=stream0)
    del arg2_1
    del arg3_1
    del arg4_1
    return (buf1, )
