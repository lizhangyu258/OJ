...
mlir_fused__to_copy_mul_6 = async_compile.mlir_auto_fallback('mlir_fused__to_copy_mul_6', '''
module {
...
''', kernel_meta={'device_str': 'npu', 'device_index': 0, 'num_outputs': 1, 'non_contiguous_indices': {'inputs': [], 'outputs': []}, 'dynamic': False, 'mutated_indices': [], 'traced_graph_cache': 'traced_graph_cache', 'traced_graph_hash': 'c35mujbucfvgqk6advxxbampeja3q2jibfmmhb2hxtxjgt2spzm6', 'num_call_functions': 2, 'signature': {0: '*f16', 1: '*f32'}, 'ranks': [4, 4], 'kernel_hash': '565dfb3172a654e1d3f7c98645e601af71500ef4ed4ff055c98dfd617fd0d65c'})
torch_npu.npu.set_device(0)


mlir_fused_mul_7 = async_compile.mlir_auto_fallback('mlir_fused_mul_7', '''
module {
  func.func @mlir_fused_mul_7(%arg0: tensor<4x8x128x64xf16>) -> tensor<4x8x64x128xf32> attributes {hacc.entry, hacc.function_kind = #hacc.function_kind<DEVICE>} {
    %cst = arith.constant 0.35355339059327379 : f64
    %0 = tensor.empty() : tensor<4x8x128x64xf32>
    %1 = hfusion.cast {round_mode = #hfusion.round_mode<rint>} ins(%arg0 : tensor<4x8x128x64xf16>) outs(%0 : tensor<4x8x128x64xf32>) -> tensor<4x8x128x64xf32>
...
''', kernel_meta={'device_str': 'npu', 'device_index': 0, 'num_outputs': 1, 'non_contiguous_indices': {'inputs': [], 'outputs': []}, 'dynamic': False, 'mutated_indices': [], 'traced_graph_cache': 'traced_graph_cache', 'traced_graph_hash': 'ct7ihleeso27dyhpl3ahfbrs3dkikf2bezub3wx7f2e5gqwws4m2', 'num_call_functions': 2, 'signature': {0: '*f16', 1: '*f32'}, 'ranks': [4, 4], 'kernel_hash': '7f6169e1326e2b443c58a83bb6f0f423a9ceb1f2bd0d1b945157eac365ba11f7'})


mlir_fused__safe_softmax_add_8 = async_compile.mlir_auto_fallback('mlir_fused__safe_softmax_add_8', '''
module {
...
''', kernel_meta={'device_str': 'npu', 'device_index': 0, 'num_outputs': 1, 'non_contiguous_indices': {'inputs': [], 'outputs': []}, 'dynamic': False, 'mutated_indices': [], 'traced_graph_cache': 'traced_graph_cache', 'traced_graph_hash': 'cyz7fbiu7kp5qjkbmcwrsu4mmp35lfldx3juwjioyvo4ghxwfy76', 'num_call_functions': 2, 'signature': {0: '*f32', 1: '*f16', 2: '*i1'}, 'ranks': [3, 4, 4], 'kernel_hash': '1d8a21a5687827aed1dfcaab7da546cf3cc32a0c132e23edb7d1dcfa885edb2f'})


mlir_fused__safe_softmax_add_9 = async_compile.mlir_auto_fallback('mlir_fused__safe_softmax_add_9', '''
module {
  func.func @mlir_fused__safe_softmax_add_9(%arg0: tensor<32x128x128xf32>, %arg1: tensor<1x1x128x128xf16>, %arg2: tensor<4x8x128x1xi1>) -> tensor<4x8x128x128xf32> attributes {hacc.entry, hacc.function_kind = #hacc.function_kind<DEVICE>} {
...
''', kernel_meta={'device_str': 'npu', 'device_index': 0, 'num_outputs': 1, 'non_contiguous_indices': {'inputs': [], 'outputs': []}, 'dynamic': False, 'mutated_indices': [], 'traced_graph_cache': 'traced_graph_cache', 'traced_graph_hash': 'czbkzxlolbc4zakt4kbypwyzjxxsrb5d2u5pfglmuiejq7obgruh', 'num_call_functions': 2, 'signature': {0: '*f32', 1: '*f16', 2: '*i1', 3: '*f32'}, 'ranks': [3, 4, 4, 4], 'kernel_hash': '80175f4951fbd9176a8c033ed66aa2fb68cb2e02ee9bd455797da2af824af7ec'})
...
"""
mlir_fused__to_copy_10 = async_compile.import_fx('mlir_fused__to_copy_10', kernel_meta={'device_str': 'npu', 'device_index': 0, 'num_outputs': 1, 'non_contiguous_indices': {'inputs': [], 'outputs': []}, 'dynamic': False, 'mutated_indices': [], 'traced_graph_cache': 'traced_graph_cache', 'traced_graph_hash': 'clqyoi3jfeiwizql6mbdrpsdqcndldzolxoc6judk2uly3drcs3y', 'num_call_functions': 1})


mlir_fused__to_copy_add_mean_mul_relu_11 = async_compile.mlir_auto_fallback('mlir_fused__to_copy_add_mean_mul_relu_11', '''
module {
  func.func @mlir_fused__to_copy_add_mean_mul_relu_11(%arg0: tensor<32x128x64xf32>, %arg1: tensor<4x8x128x64xf16>) -> tensor<4x8x128x64xf32> attributes {hacc.entry, hacc.function_kind = #hacc.function_kind<DEVICE>} {
    %c1_i64 = arith.constant 1 : i64
...
''', kernel_meta={'device_str': 'npu', 'device_index': 0, 'num_outputs': 1, 'non_contiguous_indices': {'inputs': [], 'outputs': []}, 'dynamic': False, 'mutated_indices': [], 'traced_graph_cache': 'traced_graph_cache', 'traced_graph_hash': 'cy4dxy6mweybtqfj3xxaqvfqwxi3tx5uq4jvn4dx4plggy35j72g', 'num_call_functions': 2, 'signature': {0: '*f32', 1: '*f16', 2: '*f32'}, 'ranks': [3, 4, 4], 'kernel_hash': '077f5b8862b05d9c62d1d6b9a71362735266ad83cc705d1a59fe5e9db3594a59'})
...
def call(args):
    ...
    mlir_fused__to_copy_mul_6.run(arg3_1, buf0, stream=stream0)
    buf1 = empty_strided((4, 8, 64, 128), (65536, 8192, 128, 1), device='npu', dtype=torch.float32)
    mlir_fused_mul_7.run(arg2_1, buf1, stream=stream0)
    del arg2_1
    ...
    mlir_fused__safe_softmax_add_8.run(buf3, arg0_1, buf4, stream=stream0)
    ...
    mlir_fused__safe_softmax_add_9.run(buf3, arg0_1, buf10, buf13, stream=stream0)
    del arg0_1
    del buf10
    del buf3
    buf14 = reinterpret_tensor(buf1, (4, 8, 128, 64), (65536, 8192, 64, 1), 0); del buf1  # reuse
    mlir_fused__to_copy_10.run(arg1_1, buf14, stream=stream0)
    del arg1_1
    # Topologically Sorted Source Nodes: [context], Original ATen: [aten.bmm]
    ...
    mlir_fused__to_copy_add_mean_mul_relu_11.run(buf16, arg3_1, buf18, stream=stream0)
    del arg3_1
    return (buf18, )
