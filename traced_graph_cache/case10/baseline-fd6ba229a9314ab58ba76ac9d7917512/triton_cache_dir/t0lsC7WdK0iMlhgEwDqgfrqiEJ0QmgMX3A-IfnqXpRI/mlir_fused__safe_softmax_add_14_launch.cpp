...
static void _launch(const void* func, rtStream_t stream, int gridX, void* arg0, void* arg1, void* arg2) {
  ...
  auto launch_call = [func, gridX, stream,  arg0,  arg1,  arg2]() {
    ...
    rtError_t ret = common_launch(const_cast<char*>("mlir_fused__safe_softmax_add_14"), func, gridX, static_cast<void *>(&args), sizeof(args), stream);
    return ret;
  };
  opcommand_call("mlir_fused__safe_softmax_add_14", launch_call);
}
