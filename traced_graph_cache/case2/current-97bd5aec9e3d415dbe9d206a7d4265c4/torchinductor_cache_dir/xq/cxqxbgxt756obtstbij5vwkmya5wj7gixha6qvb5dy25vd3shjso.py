...
mlir_fused__to_copy_add_mean_mul_pow_rsqrt_sub_38 = async_compile.mlir_auto_fallback('mlir_fused__to_copy_add_mean_mul_pow_rsqrt_sub_38', '''
module {
  func.func @mlir_fused__to_copy_add_mean_mul_pow_rsqrt_sub_38(%arg0: tensor<256x2048xf16>, %arg1: tensor<256x2048xf16>, %arg2: tensor<1x2048xf16>) -> tensor<256x2048xf32> attributes {hacc.entry, hacc.function_kind = #hacc.function_kind<DEVICE>} {
...
''', kernel_meta={'device_str': 'npu', 'device_index': 0, 'num_outputs': 1, 'non_contiguous_indices': {'inputs': [], 'outputs': []}, 'dynamic': False, 'mutated_indices': [], 'traced_graph_cache': 'traced_graph_cache', 'traced_graph_hash': 'cbjb3sk6sivv7wpzjur4mv3nhexvtmv7lo7pgr2sf3vqii4ec3gm', 'num_call_functions': 2, 'signature': {0: '*f16', 1: '*f16', 2: '*f16', 3: '*f32'}, 'ranks': [2, 2, 2, 2], 'kernel_hash': 'df9cbd6946469fe49ed40216d50c7addee6e9ed01332889bc77099b18c1f3ee8'})
...
def call(args):
    ...
    mlir_fused__to_copy_add_mean_mul_pow_rsqrt_sub_38.run(arg0_1, arg1_1, arg2_1, buf2, stream=stream0)
    del arg0_1
    del arg1_1
    del arg2_1
    return (buf2, )
