...
mlir_fused_add_exp_mul_permute_relu_sum_37 = async_compile.mlir_auto_fallback('mlir_fused_add_exp_mul_permute_relu_sum_37', '''
module {
  func.func @mlir_fused_add_exp_mul_permute_relu_sum_37(%arg0: tensor<32x128x64x16xf32>, %arg1: tensor<16xf32>, %arg2: tensor<32x128x64xf32>, %arg3: tensor<64xf32>, %arg4: tensor<32x128x64xf32>, %arg5: tensor<128xf32>) -> tensor<32x128x64xf32> attributes {hacc.entry, hacc.function_kind = #hacc.function_kind<DEVICE>} {
...
''', kernel_meta={'device_str': 'npu', 'device_index': 0, 'num_outputs': 1, 'non_contiguous_indices': {'inputs': [], 'outputs': []}, 'dynamic': False, 'mutated_indices': [], 'traced_graph_cache': 'traced_graph_cache', 'traced_graph_hash': 'chf5orxooavjvqd2cbsvt3cqw7n2ma3fk2nqqttrgrsezauvhtw4', 'num_call_functions': 2, 'signature': {0: '*f32', 1: '*f32', 2: '*f32', 3: '*f32', 4: '*f32', 5: '*f32', 6: '*f32'}, 'ranks': [4, 1, 3, 1, 3, 1, 3], 'kernel_hash': '83bbffad76ec48f7aeb9b71a555f9d7b927517001241f4bcb7886b3a81dd51bc'})
...
def call(args):
    ...
    mlir_fused_add_exp_mul_permute_relu_sum_37.run(arg5_1, arg4_1, arg2_1, arg0_1, arg3_1, arg1_1, buf2, stream=stream0)
    del arg0_1
    del arg1_1
    del arg2_1
    del arg3_1
