...
static void _launch(const void* func, rtStream_t stream, int gridX, void* arg0, void* arg1, void* arg2, void* arg3, void* arg4, void* arg5, void* arg6) {
  ...
  auto launch_call = [func, gridX, stream,  arg0,  arg1,  arg2,  arg3,  arg4,  arg5,  arg6]() {
    ...
    rtError_t ret = common_launch(const_cast<char*>("mlir_fused_add_exp_mul_permute_relu_sum_36"), func, gridX, static_cast<void *>(&args), sizeof(args), stream);
    return ret;
  };
  opcommand_call("mlir_fused_add_exp_mul_permute_relu_sum_36", launch_call);
}
