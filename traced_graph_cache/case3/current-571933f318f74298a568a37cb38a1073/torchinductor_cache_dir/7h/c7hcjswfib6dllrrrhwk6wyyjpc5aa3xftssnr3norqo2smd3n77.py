...
"""
mlir_fused__to_copy_40 = async_compile.import_fx('mlir_fused__to_copy_40', kernel_meta={'device_str': 'npu', 'device_index': 0, 'num_outputs': 1, 'non_contiguous_indices': {'inputs': [], 'outputs': []}, 'dynamic': False, 'mutated_indices': [], 'traced_graph_cache': 'traced_graph_cache', 'traced_graph_hash': 'cesouamzqwokrehbka7vsvh3efeqk3hlxu3gigwklg7klsus6ewm', 'num_call_functions': 1})
...
"""
mlir_fused__to_copy_41 = async_compile.import_fx('mlir_fused__to_copy_41', kernel_meta={'device_str': 'npu', 'device_index': 0, 'num_outputs': 1, 'non_contiguous_indices': {'inputs': [], 'outputs': []}, 'dynamic': False, 'mutated_indices': [], 'traced_graph_cache': 'traced_graph_cache', 'traced_graph_hash': 'cpwmybhynmbvm6p5blpmtvkb6pdhnxq5wiwids6mvsiopiw2yb52', 'num_call_functions': 1})
...
"""
mlir_fused__to_copy_42 = async_compile.import_fx('mlir_fused__to_copy_42', kernel_meta={'device_str': 'npu', 'device_index': 0, 'num_outputs': 1, 'non_contiguous_indices': {'inputs': [], 'outputs': []}, 'dynamic': False, 'mutated_indices': [], 'traced_graph_cache': 'traced_graph_cache', 'traced_graph_hash': 'cfgrdj4lrfnp4n3gu663cdzbchh7scsrmtlbjbxkdfx5wxmqrwok', 'num_call_functions': 1})


mlir_fused__to_copy_add_mean_mul_relu_43 = async_compile.mlir_auto_fallback('mlir_fused__to_copy_add_mean_mul_relu_43', '''
module {
...
''', kernel_meta={'device_str': 'npu', 'device_index': 0, 'num_outputs': 1, 'non_contiguous_indices': {'inputs': [], 'outputs': []}, 'dynamic': False, 'mutated_indices': [], 'traced_graph_cache': 'traced_graph_cache', 'traced_graph_hash': 'cl3lncaqr3bmgxltal44x4acay55bhzuez4bdddlnzdffjsb3byq', 'num_call_functions': 2, 'signature': {0: '*f32', 1: '*f16', 2: '*f16', 3: '*f32'}, 'ranks': [2, 2, 2, 2], 'kernel_hash': '6620107b13137f7b679643d1c1008640cfe789e4c858068f2649430cbb5fe125'})
...
def call(args):
    ...
    mlir_fused__to_copy_40.run(arg3_1, buf0, stream=stream0)
    del arg3_1
    buf1 = empty_strided((128, 512), (512, 1), device='npu', dtype=torch.float32)
    mlir_fused__to_copy_41.run(arg0_1, buf1, stream=stream0)
    del arg0_1
    buf2 = empty_strided((512, 512), (512, 1), device='npu', dtype=torch.float32)
    mlir_fused__to_copy_42.run(arg1_1, buf2, stream=stream0)
    del arg1_1
    ...
    mlir_fused__to_copy_add_mean_mul_relu_43.run(buf4, arg4_1, arg2_1, buf6, stream=stream0)
    del arg2_1
    del arg4_1
    return (buf6, )
