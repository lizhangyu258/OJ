...
mlir_fused_add_mean_mul_pow_rsqrt_sub_51 = async_compile.mlir_auto_fallback('mlir_fused_add_mean_mul_pow_rsqrt_sub_51', '''
module {
...
def call(args):
    ...
    mlir_fused_add_mean_mul_pow_rsqrt_sub_51.run(arg0_1, arg1_1, arg2_1, buf2, stream=stream0)
    del arg0_1
    del arg1_1
    del arg2_1
    return (buf2, )
