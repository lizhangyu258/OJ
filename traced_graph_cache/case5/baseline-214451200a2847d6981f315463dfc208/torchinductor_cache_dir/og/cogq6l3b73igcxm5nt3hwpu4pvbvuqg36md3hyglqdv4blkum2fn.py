...
mlir_fused_add_mean_mul_pow_rsqrt_sub_53 = async_compile.mlir_auto_fallback('mlir_fused_add_mean_mul_pow_rsqrt_sub_53', '''
module {
  func.func @mlir_fused_add_mean_mul_pow_rsqrt_sub_53(%arg0: tensor<32x512xf32>, %arg1: tensor<512xf32>, %arg2: tensor<512xf32>) -> tensor<32x512xf32> attributes {hacc.entry, hacc.function_kind = #hacc.function_kind<DEVICE>} {
...
def call(args):
    ...
    mlir_fused_add_mean_mul_pow_rsqrt_sub_53.run(arg0_1, arg1_1, arg2_1, buf2, stream=stream0)
    del arg0_1
    del arg1_1
    del arg2_1
    return (buf2, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg2_1 = rand_strided((512, ), (1, ), device='npu:0', dtype=torch.float32)
