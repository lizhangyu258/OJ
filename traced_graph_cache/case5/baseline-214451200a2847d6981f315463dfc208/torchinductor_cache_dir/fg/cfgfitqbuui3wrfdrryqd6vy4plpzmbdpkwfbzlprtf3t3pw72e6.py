...
mlir_fused_add_mean_mul_pow_rsqrt_sub_52 = async_compile.mlir_auto_fallback('mlir_fused_add_mean_mul_pow_rsqrt_sub_52', '''
module {
  func.func @mlir_fused_add_mean_mul_pow_rsqrt_sub_52(%arg0: tensor<32x512xf32>, %arg1: tensor<512xf32>, %arg2: tensor<512xf32>) -> (tensor<32x1xf32>, tensor<32x1xf32>, tensor<32x512xf32>) attributes {hacc.entry, hacc.function_kind = #hacc.function_kind<DEVICE>} {
...
def call(args):
    ...
    mlir_fused_add_mean_mul_pow_rsqrt_sub_52.run(primals_1, primals_2, primals_3, buf1, buf3, buf4, stream=stream0)
    del primals_2
    del primals_3
