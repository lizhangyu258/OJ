...
mlir_fused__to_copy_add_mean_mul_relu_sub_5 = async_compile.mlir_auto_fallback('mlir_fused__to_copy_add_mean_mul_relu_sub_5', '''
module {
  func.func @mlir_fused__to_copy_add_mean_mul_relu_sub_5(%arg0: tensor<256x2048xf16>, %arg1: tensor<256x2048xf16>, %arg2: tensor<1x2048xf16>, %arg3: tensor<256x1xf16>) -> tensor<256x2048xf32> attributes {hacc.entry, hacc.function_kind = #hacc.function_kind<DEVICE>} {
...
''', kernel_meta={'device_str': 'npu', 'device_index': 0, 'num_outputs': 1, 'non_contiguous_indices': {'inputs': [], 'outputs': []}, 'dynamic': False, 'mutated_indices': [], 'traced_graph_cache': 'traced_graph_cache', 'traced_graph_hash': 'cq5ghrjdethkknqsfctdygn7wufd5jb2p55hbcxd7tn6ll6qw3xq', 'num_call_functions': 2, 'signature': {0: '*f16', 1: '*f16', 2: '*f16', 3: '*f16', 4: '*f32'}, 'ranks': [2, 2, 2, 2, 2], 'kernel_hash': 'c3be385eb550253662351cf8d451ade617dd8588db66b96ba23d263aba1c4557'})
...
def call(args):
    ...
    mlir_fused__to_copy_add_mean_mul_relu_sub_5.run(arg0_1, arg1_1, arg2_1, arg3_1, buf1, stream=stream0)
    del arg0_1
    del arg1_1
    del arg2_1
    del arg3_1
