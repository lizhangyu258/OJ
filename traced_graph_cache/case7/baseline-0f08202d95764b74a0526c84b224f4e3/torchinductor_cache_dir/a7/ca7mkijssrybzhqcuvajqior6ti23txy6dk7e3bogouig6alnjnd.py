...
mlir_fused_add_mean_mul_pow_rsqrt_sub_59 = async_compile.mlir_auto_fallback('mlir_fused_add_mean_mul_pow_rsqrt_sub_59', '''
module {
  func.func @mlir_fused_add_mean_mul_pow_rsqrt_sub_59(%arg0: tensor<256x2048xf32>) -> tensor<256x2048xf32> attributes {hacc.entry, hacc.function_kind = #hacc.function_kind<DEVICE>} {
...
''', kernel_meta={'device_str': 'npu', 'device_index': 0, 'num_outputs': 1, 'non_contiguous_indices': {'inputs': [], 'outputs': []}, 'dynamic': False, 'mutated_indices': [], 'traced_graph_cache': 'traced_graph_cache', 'traced_graph_hash': 'cwcm3poqmpk6w23ud2k2esaar2yv4crgivdlgajfcyjcgma6fpi4', 'num_call_functions': 2, 'signature': {0: '*f32', 1: '*f32'}, 'ranks': [2, 2], 'kernel_hash': '92c537bef7d15ff648562f9ea7314d8263cb3611ade1ba890f499bea90151292'})
...
def call(args):
    ...
    mlir_fused_add_mean_mul_pow_rsqrt_sub_59.run(arg0_1, buf3, stream=stream0)
    del arg0_1
    return (buf3, )
