...
mlir_fused_add_mean_mul_sub_sum_2 = async_compile.mlir_auto_fallback('mlir_fused_add_mean_mul_sub_sum_2', '''
module {
  func.func @mlir_fused_add_mean_mul_sub_sum_2(%arg0: tensor<16x1000xf32>, %arg1: tensor<16x1000xf32>) -> (tensor<16xf32>, tensor<16xf32>) attributes {hacc.entry, hacc.function_kind = #hacc.function_kind<DEVICE>} {
...
''', kernel_meta={'device_str': 'npu', 'device_index': 0, 'num_outputs': 2, 'non_contiguous_indices': {'inputs': [], 'outputs': []}, 'dynamic': False, 'mutated_indices': [], 'traced_graph_cache': 'traced_graph_cache', 'traced_graph_hash': 'c73za77nxdzfmsvmulaaobsebobxp5ii3tberlspuy4zafc44vww', 'num_call_functions': 2, 'signature': {0: '*f32', 1: '*f32', 2: '*f32', 3: '*f32'}, 'ranks': [2, 2, 1, 1], 'kernel_hash': '5ac46bfab25ea3e613264ba8140e0a8bd22261bc6f32e9cf1911db630f341f02'})
torch_npu.npu.set_device(0)


mlir_fused_add_mean_mul_sub_3 = async_compile.mlir_auto_fallback('mlir_fused_add_mean_mul_sub_3', '''
module {
  func.func @mlir_fused_add_mean_mul_sub_3(%arg0: tensor<16xf32>, %arg1: tensor<16xf32>) -> tensor<f32> attributes {hacc.entry, hacc.function_kind = #hacc.function_kind<DEVICE>} {
    %c1_i64 = arith.constant 1 : i64
    %cst = arith.constant 0.000000e+00 : f32
...
''', kernel_meta={'device_str': 'npu', 'device_index': 0, 'num_outputs': 1, 'non_contiguous_indices': {'inputs': [], 'outputs': []}, 'dynamic': False, 'mutated_indices': [], 'traced_graph_cache': 'traced_graph_cache', 'traced_graph_hash': 'c6on36u23tnopokg2ylumxybnetq4tnhy7bdayivbgyqrt3vkrso', 'num_call_functions': 2, 'signature': {0: '*f32', 1: '*f32', 2: '*f32'}, 'ranks': [1, 1, 0], 'kernel_hash': '91316c738a41ed3a4ade0249e94fdd00673cc2ec7e2ffe3b950286747f30bba2'})
...
def call(args):
    ...
    mlir_fused_add_mean_mul_sub_sum_2.run(arg0_1, arg1_1, buf0, buf1, stream=stream0)
    del arg0_1
    del arg1_1
    buf3 = empty_strided((), (), device='npu', dtype=torch.float32)
    mlir_fused_add_mean_mul_sub_3.run(buf0, buf1, buf3, stream=stream0)
    return (buf3, )
