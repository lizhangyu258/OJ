...
mlir_fused_add_div_mean_mul_pow_sqrt_54 = async_compile.mlir_auto_fallback('mlir_fused_add_div_mean_mul_pow_sqrt_54', '''
module {
...
def call(args):
    ...
    mlir_fused_add_div_mean_mul_pow_sqrt_54.run(primals_1, primals_2, buf1, buf2, stream=stream0)
    del primals_2
