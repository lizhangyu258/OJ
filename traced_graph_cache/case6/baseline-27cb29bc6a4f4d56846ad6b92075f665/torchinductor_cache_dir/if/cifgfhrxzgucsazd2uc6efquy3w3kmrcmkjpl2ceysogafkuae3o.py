...
mlir_fused_add_div_mean_mul_pow_sqrt_57 = async_compile.mlir_auto_fallback('mlir_fused_add_div_mean_mul_pow_sqrt_57', '''
module {
  func.func @mlir_fused_add_div_mean_mul_pow_sqrt_57(%arg0: tensor<32x512xf32>, %arg1: tensor<512xf32>) -> tensor<32x512xf32> attributes {hacc.entry, hacc.function_kind = #hacc.function_kind<DEVICE>} {
...
''', kernel_meta={'device_str': 'npu', 'device_index': 0, 'num_outputs': 1, 'non_contiguous_indices': {'inputs': [], 'outputs': []}, 'dynamic': False, 'mutated_indices': [], 'traced_graph_cache': 'traced_graph_cache', 'traced_graph_hash': 'cenp5g2r4nlxdfih65sxt7fgta4tyc775rmjy7kvccakiul63qlb', 'num_call_functions': 2, 'signature': {0: '*f32', 1: '*f32', 2: '*f32'}, 'ranks': [2, 1, 2], 'kernel_hash': '9e4b5f2c5129c7adb26b765cf8b99212ab0d1b5692928954001661acfc3e3a11'})
...
def call(args):
    ...
    mlir_fused_add_div_mean_mul_pow_sqrt_57.run(arg0_1, arg1_1, buf1, stream=stream0)
    del arg0_1
    del arg1_1
    return (buf1, )
