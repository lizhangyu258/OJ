...
mlir_fused__to_copy_add_mul_relu_sigmoid_28 = async_compile.mlir_auto_fallback('mlir_fused__to_copy_add_mul_relu_sigmoid_28', '''
module {
  func.func @mlir_fused__to_copy_add_mul_relu_sigmoid_28(%arg0: tensor<?x?x?xf16>, %arg1: tensor<?x?x?xf16>, %arg2: tensor<1x1x?xf16>, %arg3: i64, %arg4: i64, %arg5: i64, %arg6: tensor<?x?x1xf16>) -> tensor<?x?x?xf32> attributes {hacc.entry, hacc.function_kind = #hacc.function_kind<HOST>} {
...
''', kernel_meta={'device_str': 'npu', 'device_index': 0, 'num_outputs': 1, 'non_contiguous_indices': {'inputs': [], 'outputs': []}, 'dynamic': True, 'mutated_indices': [], 'traced_graph_cache': 'traced_graph_cache', 'traced_graph_hash': 'cwf747kcqi4x7s4ojawhcsyhn3ukcw5kffne2um7oihgwof2pzks', 'num_call_functions': 2, 'signature': {0: '*f16', 1: '*f16', 2: '*f16', 3: '*!torch.int', 4: '*!torch.int', 5: '*!torch.int', 6: '*f16', 7: '*f32'}, 'ranks': [3, 3, 3, 1, 1, 1, 3, 3], 'kernel_hash': '044d631c3c348d31d9d582820b6e0ebb0d926ca498fc12d2c812eee3c256a8cf'})
torch_npu.npu.set_device(0)


mlir_fused__to_copy_add_mean_mul_pow_relu_sigmoid_sub_29 = async_compile.mlir_auto_fallback('mlir_fused__to_copy_add_mean_mul_pow_relu_sigmoid_sub_29', '''
module {
  func.func @mlir_fused__to_copy_add_mean_mul_pow_relu_sigmoid_sub_29(%arg0: tensor<?x?x?xf32>, %arg1: tensor<?x1x?xf32>, %arg2: i64, %arg3: i64, %arg4: i64) -> tensor<?x?x?xf32> attributes {hacc.entry, hacc.function_kind = #hacc.function_kind<HOST>} {
...
''', kernel_meta={'device_str': 'npu', 'device_index': 0, 'num_outputs': 1, 'non_contiguous_indices': {'inputs': [], 'outputs': []}, 'dynamic': True, 'mutated_indices': [], 'traced_graph_cache': 'traced_graph_cache', 'traced_graph_hash': 'cf3zz36eairylv6mxhmszvfss53joxvymd7j72m2zly4k4dk7nov', 'num_call_functions': 2, 'signature': {0: '*f32', 1: '*f32', 2: '*!torch.int', 3: '*!torch.int', 4: '*!torch.int', 5: '*f32'}, 'ranks': [3, 3, 1, 1, 1, 3], 'kernel_hash': '07c42359f05786e1c0b838173c272ec715b0e4eff41d06ab983bb05dea63e737'})


mlir_fused__to_copy_add_mean_mul_pow_relu_rsqrt_sigmoid_sub_30 = async_compile.mlir_auto_fallback('mlir_fused__to_copy_add_mean_mul_pow_relu_rsqrt_sigmoid_sub_30', '''
module {
  func.func @mlir_fused__to_copy_add_mean_mul_pow_relu_rsqrt_sigmoid_sub_30(%arg0: tensor<?x?x?xf32>, %arg1: tensor<?x1x?xf32>, %arg2: i64, %arg3: i64, %arg4: i64, %arg5: tensor<?x1x?xf32>) -> tensor<?x?x?xf32> attributes {hacc.entry, hacc.function_kind = #hacc.function_kind<HOST>} {
    %c1_i64 = arith.constant 1 : i64
    %c1 = arith.constant 1 : index
    %c0 = arith.constant 0 : index
    %c2 = arith.constant 2 : index
...
''', kernel_meta={'device_str': 'npu', 'device_index': 0, 'num_outputs': 1, 'non_contiguous_indices': {'inputs': [], 'outputs': []}, 'dynamic': True, 'mutated_indices': [], 'traced_graph_cache': 'traced_graph_cache', 'traced_graph_hash': 'cwshofwt2sszqgfap6zmrwxe2xb4panhfsnnzbrsy5pjyyimjk33', 'num_call_functions': 2, 'signature': {0: '*f32', 1: '*f32', 2: '*!torch.int', 3: '*!torch.int', 4: '*!torch.int', 5: '*f32', 6: '*f32'}, 'ranks': [3, 3, 1, 1, 1, 3, 3], 'kernel_hash': '050907645ef1ddfcd87c038b3badaad68139843d5e3f4f0344948d7adf88f039'})
...
def call(args):
    ...
    mlir_fused__to_copy_add_mul_relu_sigmoid_28.run(arg3_1, arg4_1, arg6_1, s0, s1, s2, arg5_1, buf0, stream=stream0)
    del arg3_1
    del arg4_1
    del arg5_1
    del arg6_1
    ...
    mlir_fused__to_copy_add_mean_mul_pow_relu_sigmoid_sub_29.run(buf0, buf2, s1, s0, s2, buf3, stream=stream0)
    ...
    mlir_fused__to_copy_add_mean_mul_pow_relu_rsqrt_sigmoid_sub_30.run(buf0, buf2, s1, s0, s2, buf5, buf6, stream=stream0)
    return (buf6, )
